...
app.post('/update-profile', function (req, res) {
  ...
  MongoClient.connect(mongoUrlLocal, mongoClientOptions, function (err, client) {
    ...
    /*
    This code is updating a document in a MongoDB collection based on a query (myquery) and applying new values (newvalues). 
    If the document is not found (upsert), a new document is created with the specified values. 
